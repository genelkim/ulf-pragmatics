...
(defparameter gotosleep '((go.v (adv-a (to.p (k sleep.n))))))
(defparameter notgotosleep '(not.adv-s (go.v (adv-a (to.p (k sleep.n))))))
(defparameter notbeaperson '(not.adv-s (be.v (= (a.d person.n)))))
(defparameter beaperson '((be.v (= (a.d person.n)))))

(defparameter ifgotosleep '((If.ps (I.pro ((cf were.v) (to (go.v (adv-a (to.p (k sleep.n)))))))) (I.pro ((cf will.aux-s) dream.v))))
(defparameter ifnotgotosleep '((If.ps (I.pro ((cf were.v) (to not.adv-s (go.v (adv-a (to.p (k sleep.n)))))))) (I.pro ((cf will.aux-s) (be.v asleep.a))) ))
